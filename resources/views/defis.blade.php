...
<head>
  ...
  <title>Zéro Déchet – Défis Communautaires</title>
...
<!-- ═══ NAVBAR ═══ -->
<nav>
  <a href="#" class="logo">Zéro Déchet</a>
  <ul class="nav-links">
    <li><a href="#">Accueil</a></li>
    <li><a href="#">Solutions</a></li>
    <li><a href="#">Impact</a></li>
    <li><a href="#" class="active">Défis</a></li>
    <li><a href="#">Blog</a></li>
...
<section class="hero">
  <div class="hero-text">
    ...
    <p>Rejoignez notre communauté engagée, participez aux défis écologiques et mesurez votre impact réel. Chaque action compte pour protéger l'avenir.</p>
    <div class="hero-actions">
      <button class="btn-primary" id="btnVoirDefis">🏆 Voir les défis</button>
      <button class="btn-outline">Mes progrès</button>
    </div>
  </div>
